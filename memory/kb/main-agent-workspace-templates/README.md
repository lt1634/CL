...
將呢個 folder 入面嘅 **IDENTITY.md、USER.md、MEMORY.md、HEARTBEAT.md** 複製去你**主 agent 的 workspace 根目錄**（例如 `~/.openclaw/workspace/`），與 **SOUL.md** 同層。
...
- **HEARTBEAT.md** — 建議每週檢查一次配置與安全狀態，維持長期穩定。
